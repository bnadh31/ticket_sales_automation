...
{
    public partial class OtobusSatis : Form
    {
        public OtobusSatis()
        {
            InitializeComponent();
        ...
        void seferleri_getir()
        {
            ...
            SqlDataAdapter ad = new SqlDataAdapter("SELECT * FROM seferler WHERE ulasim_turu = 'Otobüs'", baglanti);
            ...
            dv.RowFilter = "kalkis_yeri LIKE '" + comboBox1.Text + "' AND varis_yeri LIKE '" + comboBox2.Text + "' AND ulasim_turu LIKE 'Otobüs' AND kalkis_tarihi = '" + gidis_tarih.Text + "'";
            if (radioButton2.Checked == true)
            {
                dv2.RowFilter = "kalkis_yeri LIKE '" + comboBox2.Text + "' AND varis_yeri LIKE '" + comboBox1.Text + "' AND ulasim_turu LIKE 'Otobüs' AND kalkis_tarihi = '" + donus_tarih.Text + "'";
        ...
        void yerler_ComboBox()
        {
            ...
            string query2 = "SELECT seferler.kalkis_yeri FROM seferler WHERE ulasim_turu = 'Otobüs'";
            ...
            string query = "SELECT seferler.varis_yeri FROM seferler WHERE ulasim_turu = 'Otobüs'";
        ...
        private void OtobusSatis_Load(object sender, EventArgs e)
        {
            baglanti.Open();
            yerler_ComboBox();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
                ...
                else
                {
                    if (dataGridView1 != null && dataGridView1.CurrentRow != null && dataGridView1.CurrentRow.Cells[0].Value != null && radioButton1.Checked == true)
                    {
                        ...
                        if (reader.Read())
                        {
                            ...
                            label32.Text = dataGridView1.CurrentRow.Cells[3].Value.ToString();
                            label29.Text = dataGridView1.CurrentRow.Cells[6].Value.ToString();
                            ...
                            if (radioButton2.Checked == true)
                            {
                                ...
                                label38.Text = dataGridView2.CurrentRow.Cells[3].Value.ToString();
                                label35.Text = dataGridView2.CurrentRow.Cells[6].Value.ToString();
                                panel6.Visible = true;
                                panel5.Visible = true;
                                button_ile2(label37.Text);
                            }
                            else
                            {
            ...
            {
                MessageBox.Show("İlerleme hatası. Lütfen tekrar sefer seçimi yapınız. Hata Kodu : \n\n" + ex);
                baglanti.Close();
            }
        }
        ...
        void button_ile2(string sefer_no)
        {
            int koltukNo = 1;
            int koltukHarf = 0;
            List<string> koltuk_numaralari = new List<string>();
            baglanti.Open();
            SqlCommand komut = new SqlCommand("SELECT ulasim_araclari.koltuk_sayisi FROM ulasim_araclari, seferler WHERE seferler.arac_id = ulasim_araclari.arac_id AND seferler.sefer_id = @sefer_id", baglanti);
            komut.Parameters.AddWithValue("@sefer_id", sefer_no);
            SqlDataReader reader = komut.ExecuteReader();
            reader.Read();
            int koltuk_sayisi = int.Parse(reader["koltuk_sayisi"].ToString());
            reader.Close();
            ...
            char[] koltukHarfd = { 'A', 'B', 'C', 'D', 'E', 'F' };
            SqlCommand komut1 = new SqlCommand("SELECT biletler.koltuk_no FROM biletler WHERE sefer_id = @sefer_id", baglanti);
            komut1.Parameters.AddWithValue("@sefer_id", sefer_no);
            koltuk_numaralari.Clear();
            using (SqlDataReader reader2 = komut1.ExecuteReader())
            {
                while (reader2.Read())
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                komut.Parameters.AddWithValue("@bilet_turu", "Otobüs");
                ...
                komut2.Parameters.AddWithValue("@bilet_turu", "Otobüs");
                if (radioButton2.Checked == true)
                {
                    int rowsAffected = komut.ExecuteNonQuery();
