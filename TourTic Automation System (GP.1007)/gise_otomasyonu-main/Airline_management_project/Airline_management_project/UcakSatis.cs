...
{
    public partial class UcakSatis : Form
    {
        ...
        int musteri_id;
        private void UcakSatis_Load(object sender, EventArgs e)
        {
            baglanti.Open();
        ...
        private void koltuk_Butonu_Click(object sender, EventArgs e)
        {
        ...
        void seferleri_getir()
        {
            ...
            SqlDataAdapter ad = new SqlDataAdapter("SELECT * FROM seferler WHERE ulasim_turu = 'Uçak'", baglanti);
            ...
            dv.RowFilter = "kalkis_yeri LIKE '" + comboBox1.Text + "' AND varis_yeri LIKE '" + comboBox2.Text + "' AND ulasim_turu LIKE 'Uçak' AND kalkis_tarihi = '" + gidis_tarih.Text + "'";
            if (radioButton2.Checked == true)
            {
                dv2.RowFilter = "kalkis_yeri LIKE '" + comboBox2.Text + "' AND varis_yeri LIKE '" + comboBox1.Text + "' AND ulasim_turu LIKE 'Uçak' AND kalkis_tarihi = '" + donus_tarih.Text + "'";
        ...
        void yerler_ComboBox()
        {
            ...
            string query2 = "SELECT seferler.kalkis_yeri FROM seferler WHERE ulasim_turu = 'Uçak'";
            ...
            string query = "SELECT seferler.varis_yeri FROM seferler WHERE ulasim_turu = 'Uçak'";
        ...
        void button_ile(string ucus_no)
        {
            ...
            reader.Close();
            int taraf_koltuk_sayisi = koltuk_sayisi / 6;
        ...
        void bileti_atama()
        {
            ...
            try
            {
                ...
                komut.Parameters.AddWithValue("@bilet_turu", "Uçak");
                ...
                komut2.Parameters.AddWithValue("@bilet_turu", "Uçak");
        ...
        private void UcakSatis_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void gidis_tarih_ValueChanged(object sender, EventArgs e)
        {
